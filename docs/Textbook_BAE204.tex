...
the carbon loses all its electrons becomes CO\textsubscript{2}. Water
has also been added here, although technically in this very example all
the Hydrogen atoms on glucose end up on the oxygen atoms originally from
the O\textsubscript{2} molecule. But for more complex molecules, there
always will be some H\textsubscript{2}O molecules produced in the
process, hence the addition here.

\begin{figure}

{\centering \includegraphics[width=0.75\linewidth]{pictures/aerobic-respiration-scheme-glucose} 
...
matter: CO\textsubscript{2}, H\textsubscript{2}O, \(NH_4^+\),
HS\textsuperscript{-}, and \(PO_4^{3-}\).

\begin{figure}

{\centering \includegraphics[width=0.75\linewidth]{pictures/aerobic-respiration-scheme-OM} 
...
{\centering \includegraphics[width=0.75\linewidth]{pictures/respiration-OM} 
