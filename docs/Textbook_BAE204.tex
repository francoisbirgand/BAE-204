...
Because oxygen is the most electronegative atom (after fluorine), in
\textbf{all other molecules} where it is involved, oxygen will have 8
electrons for itself, and can therefore \textbf{never} accept more
electrons.

\section{Fully Oxidized forms of
CNSP}\label{fully-oxidized-forms-of-cnsp}

On our planet, we have the luxury to `bath' in an oxidized environment,
which means among other things, that the oxygen atom will tend to
attract all the electrons for itself when involved with CHNSP. Another
way to look at it is to say that the stable state in an aerobic
environment of the CHNSP atoms corresponds to molecules where the CHNSP
atoms will have \textbf{zero electrons} for themselves. Well, and guess
what, there are not that many possibilities, in fact only one for each
of the CNSP atoms! In Figure \ref{fig:ElecAlloc-CO2-NO3-SO4-PO4} below,
you can see that none of the CNSP atoms have electrons for themselves:
they have all been taken by the oxygen atoms!

\begin{figure}

{\centering \includegraphics[width=0.25\linewidth]{pictures/ElecAlloc_CO2} \includegraphics[width=0.25\linewidth]{pictures/ElecAlloc_NO3-} \includegraphics[width=0.25\linewidth]{pictures/ElecAlloc_SO42-} \includegraphics[width=0.25\linewidth]{pictures/ElecAlloc_PO43-} 

}

\caption{Electron allocation on each of the C, N, S, and P atoms for the CO~2~, nitrate, sulfate, and phosphate molecules, showing that C, N, S, and P atoms have no electrons for themselves, or are fully oxidized, while Oxygen has 8, or is fully reduced}\label{fig:ElecAlloc-CO2-NO3-SO4-PO4}
\end{figure}
...
\caption{Electron allocation on each of the fully oxidized forms of P, including from left to right Phosphoric acid, dihydrogen Phosphate, hydrogen phosphate, and phosphate , showing that the P atoms have no electrons for themselves}\label{fig:ElecAlloc-H3PO3-to-PO43-}
\end{figure}

\section{Oxidation versus Reduction}\label{oxidation-versus-reduction}
...
generating energy in the respiratio chain. The large number of N atoms
