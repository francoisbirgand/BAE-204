...
\caption{Respiration scheme for heterotrophic Iron oxide reduction}\label{fig:CO2-resp}
\end{figure}
...
\section{Summary on the redox chain in wetland
soils}\label{summary-on-the-redox-chain-in-wetland-soils}
...
\item
  ...
  donor. Moreover, it is exclusively the Carbon of the OM which provides
  the electrons.
\item
  ...
  PO\textsubscript{4}\textsuperscript{3-}. This means that at one point,
  all of these four (five if one counts both H\textsubscript{2}S and
  HS\textsuperscript{-}, their exact proportion depends on pH, see
  \protect\hyperlink{hydrogen-sulfide}{details in the glossary})
  molecules will accumulate where they are produced unless they are used
  by another process
\item
